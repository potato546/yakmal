...
- ingredients: 주성분·원료·전성분 정보가 있을 때만. [{"name_ko":..., "name_tr":..., "amount":..., "role_ko":..., "role_tr":...}].
  ...
  괄호로 병기. name은 고객이 알아들을 이름. role은 1~2문장, 과장 없이 — 반드시 이 제품의 [효능효과] 원문 맥락 안에서만 설명할 것.
  같은 성분이 다른 제품·다른 질환에는 다르게 쓰이더라도(예: 산화마그네슘은 제산제로도 쓰이지만 이 제품이 종합영양제면 "마그네슘 보충으로
  근육·신경 기능 유지"처럼 이 제품 목적에 맞게), 이 제품과 무관한 다른 용도를 가져다 설명하지 말 것. 화장품은 핵심 역할 성분 3~5개만.
  정보가 없으면 빈 배열. 반드시 객체 배열로.
